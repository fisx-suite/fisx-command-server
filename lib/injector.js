...
function findAMDModuleConfig() {
    var result = fis.config.get('modules.hook') || [];
...
function getRequireConfig(options, context) {
    ...
    customConfig = customConfig
        && customConfig[options.serveRelease ? 'release' : 'debug'];
    ...
    if (_.isFunction(customConfig)) {
        ...
        requireConfig = _.assign(requireConfig || {}, customConfig);
    }
 ...
 * @return {Function}
 */
exports.getRequireConfigInjector = function (options) {
    options || (options = {});
